          ...
          <li>
            <?php
              if($_SESSION['page'] == "students"){
                echo '<a class="active" href="students.php"><i id="sidebarIcon"></i>Student Files</a>';
              } else {
                echo '<a href="students.php"><i id="sidebarIcon"></i>Student Files</a>';
              }
            ?>
          </li>
          <li>
            <?php
              if($_SESSION['page'] == "staffs"){
                echo '<a class="active" href="staffs.php"><i id="sidebarIcon"></i>School Staff Files</a>';
              } else {
                echo '<a href="staffs.php"><i id="sidebarIcon"></i>School Staff Files</a>';
              }
            ?>
          </li>
          <li>
