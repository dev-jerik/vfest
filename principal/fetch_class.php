  ...
  <div class="table-responsive">
   <table class="table table bordered">
    <tr>
      ...
      <th class="table-header" width="20%" style="text-align:center" colspan="2">View</th>
    </tr>
 ';
 ...
 while($row = mysqli_fetch_array($result))
 {
  ...
  while($ctr != $id ){
    ...
    <tr>
      ...
      <td style="text-align:center"><a class="disable" id="edit" href="" title="No Student">Students</a></td>
      <td style="text-align:center"><a id="edit" href="class_subjects.php?year='.$year.'&levelId='.$ctr.'&level='.$level.'">Subjects</a></td>
    </tr>
    ';
    $ctr = $ctr+1;
  }
  ...
  <tr>
    ...
    <td style="text-align:center"><a id="edit" href="class_students.php?year='.$year.'&levelId='.$row["GradeId"].'&level='.$row["Level"].'">Students</a></td>
    <td style="text-align:center"><a id="edit" href="class_subjects.php?year='.$year.'&levelId='.$row["GradeId"].'&level='.$row["Level"].'">Subjects</a></td>
  </tr>
  ';
  $ctr = $ctr+1;
 }
